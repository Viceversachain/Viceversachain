...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # details.
  CI_EXEC 'grep -v HAVE_SYS_GETRANDOM src/config/viceversachain-config.h > src/config/viceversachain-config.h.tmp && mv src/config/viceversachain-config.h.tmp src/config/viceversachain-config.h'
fi
