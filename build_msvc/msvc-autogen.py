...
libs = [
    'libviceversachain_cli',
    'libviceversachain_common',
    'libviceversachain_crypto',
    'libviceversachain_node',
    'libviceversachain_util',
    'libviceversachain_wallet_tool',
    'libviceversachain_wallet',
    'libviceversachain_zmq',
    'bench_viceversachain',
    'libtest_util',
]
...
def parse_config_into_btc_config():
    ...
    config_dict["PACKAGE_STRING"] = f"\"Viceversachain Core {version}\""

    with open(os.path.join(SOURCE_DIR,'../build_msvc/viceversachain_config.h.in'), "r", encoding="utf8") as template_file:
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/viceversachain_config.h'), "w", encoding="utf8") as btc_config:
...
def main():
    parser = argparse.ArgumentParser(description='Viceversachain-core msbuild configuration initialiser.')
    ...
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/viceversachain_config.h'), os.path.join(SOURCE_DIR, 'config/viceversachain-config.h'))
