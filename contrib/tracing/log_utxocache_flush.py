...
"""Example logging Viceversachain Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/viceversachaind
...
def main(viceversachaind_path):
    ...
    b = BPF(text=program, usdt_contexts=[viceversachaind_with_usdts])
