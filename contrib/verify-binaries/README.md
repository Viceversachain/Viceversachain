...
As of Viceversachain Core v22.0, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.com/viceversachain-core/guix.sigs/). When
...
builder-keys](https://github.com/viceversachain-core/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://viceversachaincore.org and https://viceversachain.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/viceversachain-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/viceversachain-24.0.1-arm-linux-gnueabihf.tar.gz
```
