...
complete --command viceversachain-tx --no-files

# Modified version of __fish_seen_subcommand_from
# Uses regex to detect cmd= syntax
function __fish_viceversachain_seen_cmd
...
# Extract options
function __fish_viceversachain_tx_get_options
...
# Extract commands
function __fish_viceversachain_tx_get_commands
...
# Add options
complete \
    --command viceversachain-tx \
    --condition "not __fish_viceversachain_seen_cmd (__fish_viceversachain_tx_get_commands --commandsonly)" \
    --arguments "(__fish_viceversachain_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command viceversachain-tx \
    --arguments "(__fish_viceversachain_tx_get_commands)" \
    --no-files
