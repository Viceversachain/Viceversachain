...
complete --command viceversachain-qt --no-files

# Extract options
function __fish_viceversachainqt_get_options
...
complete \
    --command viceversachain-qt \
    --arguments "(__fish_viceversachainqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c viceversachain-qt \
...
complete \
    --command viceversachain-qt \
    --arguments "(__fish_viceversachainqt_get_options --nofiles)"
