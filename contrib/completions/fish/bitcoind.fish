...
complete --command viceversachaind --no-files

# Extract options
function __fish_viceversachaind_get_options
...
complete \
    --command viceversachaind \
    --arguments "(__fish_viceversachaind_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command viceversachaind \
...
complete \
    --command viceversachaind \
    --arguments "(__fish_viceversachaind_get_options --nofiles)"
