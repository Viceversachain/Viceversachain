...
(
    ...
    # Setup the directory where our Viceversachain Core build for HOST will be
    # installed. This directory will also later serve as the input for our
    # binary tarballs.
    INSTALLPATH="${PWD}/installed/${DISTNAME}"
    mkdir -p "${INSTALLPATH}"
    # Install built Viceversachain Core to $INSTALLPATH
    case "$HOST" in
        *darwin*)
    ...
    (
        ...
        # copy over the example viceversachain.conf file. if contrib/devtools/gen-viceversachain-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/share/examples/viceversachain.conf" "${DISTNAME}/"
