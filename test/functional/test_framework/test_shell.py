...
class TestShell:
    """Wrapper Class for ViceversachainTestFramework.

    The TestShell class extends the ViceversachainTestFramework
    ...
    class __TestShell(ViceversachainTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ViceversachainTestFramework child class.
            self.num_nodes = 1
