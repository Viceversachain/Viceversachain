...
class P2PDNSSeeds(ViceversachainTestFramework):
    ...
    def init_arg_tests(self):
        ...
        # Restore default viceversachaind settings
        self.restart_node(0)
    ...
    def force_dns_test(self):
        ...
        with self.nodes[0].assert_debug_log(expected_msgs=["Loading addresses from DNS seed"], timeout=12):
            # -dnsseed defaults to 1 in viceversachaind, but 0 in the test framework,
