...
class PSBTTest(ViceversachainTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test walletcreatefundedpsbt fee rate of 10000 sat/vB and 0.1 VVC/kvB produces a total fee at or slightly below -maxtxfee (~0.05290000)")
