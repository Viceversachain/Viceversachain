#!/usr/bin/env python3
# Copyright (c) 2014-2019 The Viceversachain Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test running viceversachaind with the -rpcbind and -rpcallowip options."""
...
class RPCBindTest(ViceversachainTestFramework):
