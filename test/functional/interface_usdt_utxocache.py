#!/usr/bin/env python3
# Copyright (c) 2022 The Viceversachain Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

""" Tests the utxocache:* tracepoint API interface.
    See https://github.com/viceversachain/viceversachain/blob/master/doc/tracing.md#context-utxocache
"""
...
class UTXOCacheTracepointTest(ViceversachainTestFramework):
    ...
    def skip_test_if_missing_module(self):
        ...
        self.skip_if_no_viceversachaind_tracepoints()
    ...
    def test_uncache(self):
        ...
        https://github.com/viceversachain/viceversachain/blob/master/doc/tracing.md#tracepoint-utxocacheuncache
        """
    ...
    def test_add_spent(self):
        """ Tests the utxocache:add utxocache:spent tracepoint API
            See https://github.com/viceversachain/viceversachain/blob/master/doc/tracing.md#tracepoint-utxocacheadd
            and https://github.com/viceversachain/viceversachain/blob/master/doc/tracing.md#tracepoint-utxocachespent
        """
    ...
    def test_flush(self):
        """ Tests the utxocache:flush tracepoint API.
            See https://github.com/viceversachain/viceversachain/blob/master/doc/tracing.md#tracepoint-utxocacheflush"""
