...
Verify that a viceversachaind node can use an external signer command.
...
class RPCSignerTest(ViceversachainTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart viceversachaind with -signer=<cmd>',
