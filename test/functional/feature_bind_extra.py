...
"""
Test starting viceversachaind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(ViceversachainTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that viceversachaind has bound on "::1" (for RPC) and "::" (for P2P).
