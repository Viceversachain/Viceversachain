...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/viceversachain/viceversachain/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(ViceversachainTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our viceversachaind node")
