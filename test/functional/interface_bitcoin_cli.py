...
# The block reward of coinbaseoutput.nValue (50) VVC/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 VVC/block.
...
class TestViceversachainCli(ViceversachainTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `viceversachain-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and viceversachain-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and viceversachain-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (VVC/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (VVC/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 VVC) to the default wallet.
            ...
            # Test viceversachain-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test viceversachain-cli -generate with -rpcwallet in multiwallet mode.
