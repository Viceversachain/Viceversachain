...
# TestP2PConn: A peer we use to send messages to viceversachaind, and store responses.
...
class CompactBlocksTest(ViceversachainTestFramework):
    ...
    # This test actually causes viceversachaind to (reasonably!) disconnect us, so do this last.
    ...
    # viceversachaind's choice of nonce.
    ...
    # Test that viceversachaind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for viceversachaind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # viceversachaind will not send blocktxn responses for blocks whose height is
