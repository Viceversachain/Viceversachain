...
class TxDownloadTest(ViceversachainTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new viceversachaind instances, as setting mocktimes has long-term effects on when
