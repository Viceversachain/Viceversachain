...
By default, viceversachaind will dump mempool on shutdown and
...
class MempoolPersistTest(ViceversachainTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent viceversachaind from writing mempool.dat to disk. Verify that `savemempool` fails")
