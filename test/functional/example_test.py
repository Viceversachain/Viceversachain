...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ViceversachainTestFramework
    pass


class ExampleTest(ViceversachainTestFramework):
    # Each functional test is a subclass of the ViceversachainTestFramework class.
    ...
    def custom_method(self):
        ...
        ViceversachainTestFramework class so other tests can use it."""
