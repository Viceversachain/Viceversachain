...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/viceversachain/viceversachain/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(ViceversachainTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/viceversachain/viceversachain/blob/master/doc/tracing.md#tracepoint-validationblock_connected
