Viceversachain version 0.6.2 is now available for download at:
http://sourceforge.net/projects/viceversachain/files/Viceversachain/viceversachain-0.6.2/
...
Fixed https://github.com/viceversachain/viceversachain/issues/1065, a bug that
