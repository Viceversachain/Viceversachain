Viceversachain version 0.5.4 is now available for download at:
http://sourceforge.net/projects/viceversachain/files/Viceversachain/viceversachain-0.5.4/
...
http://gitorious.org/viceversachain/viceversachaind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Viceversachain-Qt notifications under Growl 1.3.
Increase required age of Viceversachain-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxViceversachain properly when installing Viceversachain-Qt over it. (Windows)
