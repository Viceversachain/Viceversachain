...
Viceversachain Core version 0.19.1 is now available from:

  <https://viceversachaincore.org/bin/viceversachain-core-0.19.1/>
...
From Viceversachain Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Viceversachain Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Viceversachain Core does not yet change appearance when
...
- #17488 fix "viceversachaind already running" warnings on macOS (fanquake)
