Viceversachain Core version 0.13.2 is now available from:

  <https://viceversachain.org/bin/viceversachain-core-0.13.2/>
...
- #8908 `4a974b2` Update viceversachain-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow viceversachain-tx to create v2 transactions (btcdrak)
