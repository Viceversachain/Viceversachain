Viceversachain Core version *0.15.2* is now available from:

  <https://viceversachaincore.org/bin/viceversachain-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in viceversachain-tx (TheBlueMatt)
