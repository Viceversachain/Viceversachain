Viceversachain-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/viceversachain/files/Viceversachain/viceversachain-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Viceversachain
...
New/changed settings (command-line or viceversachain.conf file)
--------------------------------------------------------
