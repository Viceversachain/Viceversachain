Viceversachain Core version *0.15.0.1* is now available from:

  <https://viceversachain.org/bin/viceversachain-core-0.15.0.1/>

and

  <https://viceversachaincore.org/bin/viceversachain-core-0.15.0.1/>
