Viceversachain Core version 0.10.4 is now available from:

  <https://viceversachain.org/bin/viceversachain-core-0.10.4/>
...
- #6953 `43c2789` Split viceversachain-tx into its own package
- #6953 `dfe0d4d` Include viceversachain-tx binary on Debian/Ubuntu
