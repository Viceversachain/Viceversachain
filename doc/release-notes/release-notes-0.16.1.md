Viceversachain Core version 0.16.1 is now available from:

  <https://viceversachaincore.org/bin/viceversachain-core-0.16.1/>
...
- #12843 `df38b13` Test starting viceversachaind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure viceversachaind processes are cleaned up when tests end (sdaftuar)
