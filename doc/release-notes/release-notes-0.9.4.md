Viceversachain Core version 0.9.4 is now available from:

  https://viceversachain.org/bin/0.9.4/
...
this update is incompatible with the Viceversachain system and could lead to consensus
forks.

Viceversachain Core released binaries from https://viceversachain.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~viceversachain/+archive/ubuntu/viceversachain
- A third-party or self-compiled Viceversachain Core

upgrade to Viceversachain Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
