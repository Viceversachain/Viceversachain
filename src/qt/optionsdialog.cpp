      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->viceversachainAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->viceversachainAtStartup);
    ...
    ui->viceversachainAtStartup->setToolTip(ui->viceversachainAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->viceversachainAtStartup->setText(ui->viceversachainAtStartup->text().arg(PACKAGE_NAME));

    ui->openViceversachainConfButton->setToolTip(ui->openViceversachainConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ViceversachainUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->viceversachainAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSVVControls);
...
void OptionsDialog::on_openViceversachainConfButton_clicked()
{
    ...
    if (!GUIUtil::openViceversachainConf())
