...
{
    // Test regression https://github.com/viceversachain/viceversachain/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/viceversachain-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/viceversachain-core/gui/pull/568.
    // With fListen=false in ~/.config/Viceversachain/Viceversachain-Qt.conf and all else left as default,
    // viceversachain-qt should set both -listen and -listenonion to false and start successfully.
