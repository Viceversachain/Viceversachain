...
//! Entry point for ViceversachainApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ViceversachainApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ViceversachainGUI tests.
void AppTests::guiTests(ViceversachainGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ViceversachainGUI::consoleShown, this, &AppTests::consoleTests);
