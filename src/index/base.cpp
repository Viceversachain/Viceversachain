...
void BaseIndex::BlockConnected(const std::shared_ptr<const CBlock>& block, const CBlockIndex* pindex)
{
    ...
    if (!best_block_index) {
        ...
        // ViceversaChain: Parent has HIGHER height (toward genesis at 100M), so use +1 not -1
...
bool BaseIndex::Start()
{
    ...
    // removed in followup https://github.com/viceversachain/viceversachain/pull/24230
