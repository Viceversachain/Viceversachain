 ...
 *  A CTxDestination is the internal data type encoded in a viceversachain address
 */
...
/**
 * Generate a Viceversachain scriptPubKey for the given CTxDestination. Returns a P2PKH
