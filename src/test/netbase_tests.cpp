// Copyright (c) 2012-2022 The Viceversachain Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.viceversachaincore.org", "www.viceversachaincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.viceversachaincore.org]", "www.viceversachaincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.viceversachaincore.org:80", "www.viceversachaincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.viceversachaincore.org]:80", "www.viceversachaincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.viceversachaincore.org:65536", "www.viceversachaincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.viceversachaincore.org:0", "www.viceversachaincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.viceversachaincore.org:", "www.viceversachaincore.org:", 0, false));
}
