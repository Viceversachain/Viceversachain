...
// ViceversaChain: External declarations for reward addresses
extern const std::string FOUNDER_ADDRESS;
extern const std::string TEAM_ADDRESS;
...
static UniValue GetNetworkHashPS(int lookup, int height, const CChain& active_chain) {
    ...
    for (int i = 0; i < lookup; i++) {
        if (!pb0->pprev) {
            // Not enough blocks available, use what we have
            lookup = i;
            break;
        }
        pb0 = pb0->pprev;
...
static RPCHelpMan generatetodescriptor()
{
    return RPCHelpMan{
        ...
        "Mine to a specified descriptor and return the block hashes.",
        {
            ...
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated viceversachain to."},
        ...
        "Mine to a specified address and return the block hashes.",
         {
             ...
             {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated viceversachain to."},
             {"maxtries", RPCArg::Type::NUM, RPCArg::Default{DEFAULT_MAX_TRIES}, "How many iterations to try."},
         },
         RPCResult{
             RPCResult::Type::ARR, "", "hashes of blocks generated",
         ...
         RPCExamples{
            ...
            + "If you are using the " PACKAGE_NAME " wallet, you can get a new address to send the newly generated viceversachain to with:\n"
...
static RPCHelpMan generateblock()
{
    return RPCHelpMan{"generateblock",
        ...
        {
            {"output", RPCArg::Type::STR, RPCArg::Optional::NO, "The address or descriptor to send the newly generated viceversachain to."},
...
// NOTE: Unlike wallet RPC (which use VVC values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
...
static RPCHelpMan getblocktemplate()
{
    return RPCHelpMan{"getblocktemplate",
        ...
        "    https://github.com/viceversachain/bips/blob/master/bip-0022.mediawiki\n"
        "    https://github.com/viceversachain/bips/blob/master/bip-0023.mediawiki\n"
        "    https://github.com/viceversachain/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
        "    https://github.com/viceversachain/bips/blob/master/bip-0145.mediawiki\n",
        {
        ...
        },
        {
            ...
            RPCResult{"Otherwise", RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::STR, "founderaddress", "ViceversaChain: address for founder reward output (1.5% of block subsidy)"},
                {RPCResult::Type::NUM, "foundervalue", "ViceversaChain: founder reward amount in satoshis (1.5% of block subsidy)"},
                {RPCResult::Type::STR, "teamaddress", "ViceversaChain: address for team reward output (6.5% of block subsidy)"},
                {RPCResult::Type::NUM, "teamvalue", "ViceversaChain: team reward amount in satoshis (6.5% of block subsidy)"},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    // ViceversaChain: Add founder and team reward info for external miners
    result.pushKV("founderaddress", FOUNDER_ADDRESS);
    result.pushKV("foundervalue", (int64_t)pblock->vtx[0]->vout[1].nValue);
    result.pushKV("teamaddress", TEAM_ADDRESS);
    result.pushKV("teamvalue", (int64_t)pblock->vtx[0]->vout[2].nValue);
    ...
    result.pushKV("height", (int64_t)(pindexPrev->nHeight-1)); // ViceversaChain: blocks decrement
...
static RPCHelpMan submitblock()
{
    ...
    return RPCHelpMan{"submitblock",
        ...
        "See https://en.viceversachain.it/wiki/BIP_0022 for full specification.\n",
        {
