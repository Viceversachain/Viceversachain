...
/* src/config/viceversachain-config.h.  Generated from viceversachain-config.h.in by configure.  */
/* src/config/viceversachain-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Viceversachain Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Viceversachain Core"
...
#define PACKAGE_BUGREPORT "https://github.com/viceversachain/viceversachain/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Viceversachain Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Viceversachain Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "viceversachain"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://viceversachaincore.org/"
