 ...
 * src/qt/guiutil.cpp and src/viceversachain-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Viceversachain’s Peer-to-Peer Network")
