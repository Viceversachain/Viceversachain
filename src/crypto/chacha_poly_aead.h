// Copyright (c) 2019-2021 The Viceversachain Core developers
...
/* A AEAD class for ChaCha20-Poly1305@viceversachain.
 *
 ...
 *
 * The chacha20-poly1305@viceversachain combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@viceversachain cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@viceversachain are relatively fast in
