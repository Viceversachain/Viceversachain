...
const std::string CURRENCY_UNIT = "VIVE"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    VIVE_KVB,      //!< Use VIVE/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::VIVE_KVB) const;
